  ...
  return (
    <div className="container">
      ...
      <main className="main">
        <h1>動けば正義のアプリ集</h1>
        <p className="intro">
          こんにちは。ミスっても直せばいい。完璧に覚える必要もないし、絶対に失敗が許されないわけでもない。<br />「バグかー、直そ！」<br />
          っていうテンションが許されるプログラミングの世界が好きになって、気づいたらドハマリしていました。<br />
          最初はうまくいかなくて当然だよ 🥺 動かしながらちょっとずつ良くしていければいいよね。
          <br />そういう文化が凄くやさしく感じます。<br />
          完璧を求められて鬱で苦しくなってる人へ。<br />
          もしかしたら、プログラミングにちょっと触れてみるだけで、心がすこし楽になるかもしれないです。
        </p>
