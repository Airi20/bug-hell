  ...
  return (
    <div className="container">
      ...
      <main className="main">
        <h1>動けば正義のアプリ集</h1>
        <p className="intro">
          こんにちは。日々アプリを作って現実逃避している人間です。自分でも何個作ったのか分からないのでとりあえず覚えてる範囲内でかき集めたものを載せました。有名どころからなんじゃこりゃ誰に需要あるんだよみたいなアプリまで様々です。<br />
          どれも動けば正義なので、気軽に遊んでみてください。<br />
          最近鬱です。助けてください。<br />
          ま、ダラダラ生きれるうちはダラダラ生きていこうと思います。<br />
          もし気に入ったら、インスタやGitHubもフォローしてくれると嬉しいです。<br />
          DM送ってくれたら（即レスはできないけど）すぐ返します。（多分） <br />
          <br />
          それでは、アプリをお楽しみください！(๑•̀ㅂ•́)و✧
