  ...
  return (
    <div style={{ maxWidth: 600, margin: "auto", fontFamily: "Arial, sans-serif", padding: 20 }}>
      ...
      <p style={{ whiteSpace: "pre-wrap" }}>
        こんにちは。工学系の大学３年生です。
        個人でWebアプリの開発を続けています。
        <br />もともとは進級や進路の不安もあって、気づけば「作ること」で自分を保っていた部分もありましたが、今ではアプリ開発が自分にとっての表現手段であり、スキルアップのための大事な時間になっています。
        <br />このサイトでは、これまでに作成したWebアプリをまとめています。まだまだ粗削りな部分も多いですが、「実際に形にすること」を第一に取り組んできました。
        今後はネイティブアプリの開発にも挑戦したいと考えており、より多くの人に使ってもらえるプロダクトを目指してスキルを磨いていきます。
